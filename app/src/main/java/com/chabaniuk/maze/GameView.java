...
public class GameView extends View {
    ...
    public GameView(Context context, @Nullable AttributeSet attrs) {
        ...
        playerPaint.setColor(Color.rgb(223, 235, 16));

        exitPaint = new Paint();
        exitPaint.setColor(Color.rgb(24, 201, 27));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(Color.rgb(250, 240, 202));
